...
unsafe impl Allocator for Vmalloc {
    const MIN_ALIGN: usize = crate::page::PAGE_SIZE;
...
mod tests {
    use crate::{
        alloc::{allocator::*, flags::GFP_KERNEL, *},
        error::Result,
    };
    ...
    fn test_alignment() -> Result {
        ...
        const TEST_LARGE_ALIGN_SIZE: usize = crate::page::PAGE_SIZE * 4;
